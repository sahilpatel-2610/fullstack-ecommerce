...
const EditHomeSlide = () => {
    ...
    const editHomeSlide = (e) => {
        ...
        if (appendedArray.length !== 0) {
            ...
            editData(`/api/homeBanner/${id}`, postObj).then(res => {
                setIsLoading(false);
                context.setAlertBox({
                    open: true,
                    error: false,
        ...
        <div className="right-content w-100">
            <div className="card shadow border-0 w-100 flex-row p-4 mt-2">
                ...
                <Breadcrumbs aria-label="breadcrumb" className="ms-auto breadcrumbs_">
                    ...
                    <StyledBreadcrumb label="Edit Home Slide" deleteIcon={<ExpandMoreIcon />} />
                </Breadcrumbs>
            </div>
                        ...
                        <div className="card p-4 mt-0">
                            <div className="imagesUploadSec">
                                ...
                                <Button type="submit" className="btn-blue btn-lg btn-big w-100">
                                    <FaCloudUploadAlt /> &nbsp; {isLoading === true ? <CircularProgress color="inherit" className="loader" /> : 'UPDATE SLIDE'}
                                </Button>
                            </div>
                        </div>
                    </div>
