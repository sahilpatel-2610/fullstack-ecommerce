...
const EditHomeBottomBanner = () => {
    ...
    const editHomeBottomBanner = (e) => {
        ...
        if (appendedArray.length !== 0) {
            ...
            editData(`/api/homeBottomBanners/${id}`, postObj).then(res => {
                setIsLoading(false);
                context.setAlertBox({
                    open: true,
                    error: false,
    ...
    const removeImg = (index, imgUrl) => {
        deleteImages(`/api/homeBottomBanners/deleteImage?img=${imgUrl}`);
        ...
        <div className="right-content w-100">
            <div className="card shadow border-0 w-100 flex-row p-4 mt-2">
                ...
                <Breadcrumbs aria-label="breadcrumb" className="ms-auto breadcrumbs_">
                    ...
                    <StyledBreadcrumb label="Edit Home Bottom Banner" deleteIcon={<ExpandMoreIcon />} />
                </Breadcrumbs>
            </div>

            <form className="form" onSubmit={editHomeBottomBanner}>
...
export default EditHomeBottomBanner;
