...
const AddHomeSideBanner = () => {
    ...
    const addBanner = (e) => {
        ...
        if (previews.length !== 0) {
            ...
            postData(`/api/homeSideBanners/create`, postObj).then(res => {
                setIsLoading(false);
                context.setAlertBox({
                    open: true,
                    error: false,
                    msg: "Home Side Banner Added Successfully!"
                });
        ...
        <div className="right-content w-100">
            <div className="card shadow border-0 w-100 flex-row p-4 mt-2">
                ...
                <Breadcrumbs aria-label="breadcrumb" className="ms-auto breadcrumbs_">
                    ...
                    <StyledBreadcrumb label="Home Side Banner" deleteIcon={<ExpandMoreIcon />} />
...
export default AddHomeSideBanner;
