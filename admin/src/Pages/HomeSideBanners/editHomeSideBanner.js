...
const EditHomeSideBanner = () => {
    ...
    const editHomeSideBanner = (e) => {
        ...
        if (appendedArray.length !== 0) {
            ...
            editData(`/api/homeSideBanners/${id}`, postObj).then(res => {
                setIsLoading(false);
                context.setAlertBox({
                    open: true,
                    error: false,
    ...
    const removeImg = (index, imgUrl) => {
        deleteImages(`/api/homeSideBanners/deleteImage?img=${imgUrl}`);
        ...
        <div className="right-content w-100">
            <div className="card shadow border-0 w-100 flex-row p-4 mt-2">
                ...
                <Breadcrumbs aria-label="breadcrumb" className="ms-auto breadcrumbs_">
                    ...
                    <StyledBreadcrumb label="Edit Home Side Banner" deleteIcon={<ExpandMoreIcon />} />
                </Breadcrumbs>
            </div>

            <form className="form" onSubmit={editHomeSideBanner}>
                            ...
                            <div className="imagesUploadSec">
                                ...
                                <div className="imgUploadBox d-flex align-items-center">
                                    ...
                                    <div className="uploadBox">
                                        <input type="file" multiple onChange={(e) => onChangeFile(e, '/api/homeSideBanners/upload')} name="images" />
                                        <div className="info">
                                            <FaRegImages />
                                            <h5>image upload</h5>
                                        </div>
...
export default EditHomeSideBanner;
