...
const HomeSideBannerList = () => {
    ...
    useEffect(() => {
        ...
        fetchDataFromApi('/api/homeSideBanners?page=1&perPage=10').then((res) => {
            setSlideList(res);
        ...
        <>
            ...
            <div className="right-content w-100">
                <div className="card shadow border-0 w-100 flex-row p-4">
                    ...
                    <Link to="/homeSideBanner/add"><Button className="btn-blue ms-3 ps-3 pe-3">Add Home Side Banner</Button></Link>
                </div>
                                    ...
                                    <tr key={item._id}>
                                        ...
                                        <td>
                                            <div className="actions d-flex align-items-center">
                                                <Link to={`/homeSideBanner/edit/${item._id}`}>
...
export default HomeSideBannerList;
