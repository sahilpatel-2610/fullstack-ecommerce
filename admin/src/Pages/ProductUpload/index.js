...
//         setisFeatredValue(event.target.value);
//         setFormFields(() => ({
//             ...formFields,
...
//     //         await postData('/api/products/create', data);
...
//                                                 <input type="text" ref={productImages} style={{paddingRight:'100px'}} name="images" onChange={inputChange} />
