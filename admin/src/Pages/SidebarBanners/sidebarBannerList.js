...
const SidebarBannerList = () => {
    ...
    useEffect(() => {
        ...
        fetchDataFromApi('/api/sidebarBanners?page=1&perPage=10').then((res) => {
            setSlideList(res);
    ...
    const deleteSlide = (id) => {
        ...
        deleteData(`/api/sidebarBanners/${id}`).then(res => {
            fetchDataFromApi('/api/sidebarBanners?page=1&perPage=10').then((res) => {
                setSlideList(res);
                context.setProgress(100);
                context.setAlertBox({
        ...
        <>
            ...
            <div className="right-content w-100">
                <div className="card shadow border-0 w-100 flex-row p-4">
                    <h5 className="mb-0">Sidebar Banner List</h5>
                    ...
                    <Link to="/sidebarBanner/add"><Button className="btn-blue ms-3 ps-3 pe-3">Add Sidebar Banner</Button></Link>
                </div>
                                    ...
                                    <tr key={item._id}>
                                        ...
                                        <td>
                                            <div className="actions d-flex align-items-center">
                                                <Link to={`/sidebarBanner/edit/${item._id}`}>
...
export default SidebarBannerList;
